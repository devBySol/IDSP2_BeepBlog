...
export function Footer() {
  return (
    <footer className="bg-[#651fd7] border-t border-neutral-200 dark:bg-slate-800">
      <Container>
        <div className="py-28 flex flex-col lg:flex-row items-center mb-1">
          <img src="/favicon/footerLogo.png" alt="logo" width={200} height={200} className="lg:mr-6 mb-6 lg:mb-0" />
